...
public:
  ...
  StaticNArrayShape(const self_t&) = default;
...
public:
  ...
  NArrayMemoryStack(self_t&&) = delete;

  // copy construction is deleted
  NArrayMemoryStack(const self_t&) = delete;

  self_t&
  operator=(self_t&&) = delete;

  self_t&
  operator=(const self_t&) = delete;
...
public:
  ...
  NArrayView(const self_t&) = default;
