...
c          if ( zone .eq. 1 ) then
c            call print_zone(u(start5(iz)),
c     $              nx(zone), nxmax(zone), ny(zone), nz(zone), zone, -1)
c          endif
       end do
...
c          if ( zone .eq. 1 ) then
c            call print_zone(u(start5(iz)),
c     $              nx(zone), nxmax(zone), ny(zone), nz(zone), zone, 0)
c          endif
...
c           if ( zone .eq. 1 ) then
c             call print_zone(u(start5(iz)),
c     $            nx(zone), nxmax(zone), ny(zone), nz(zone), zone, step)
c           endif
           call adi(rho_i(start1(iz)), us(start1(iz)),
     $              vs(start1(iz)), ws(start1(iz)),
     $              qs(start1(iz)), square(start1(iz)),
